    ...
    function Home(props) {
      ...
      if (!props.location.query.filter) {
        Car.get().then(function (cars) {
          return _this.setState({ cars: cars });
        });
      }
      return _this;
    }
    ...
    _createClass(Home, [{
      ...
      value: function componentDidUpdate() {
        ...
        if (filter && filter != this.state.searched) {
          ...
          Car.getByFilter(filter).then(function (cars) {
